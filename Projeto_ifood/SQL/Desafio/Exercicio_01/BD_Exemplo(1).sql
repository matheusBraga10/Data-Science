...
--Script para criar o Banco de Dados (BD_Exemplo) e suas tabelas, al�m de popul�-las.
...
INSERT INTO Departamentos VALUES('D1','Pesquisa','Dallas')
INSERT INTO Departamentos VALUES('D2','Contabilidade','Seattle')
INSERT INTO Departamentos VALUES('D3','Marketing','Dallas')
GO

INSERT INTO Projetos VALUES('P1','Apollo',120000)
INSERT INTO Projetos VALUES('P2','Gemini',95000)
INSERT INTO Projetos VALUES('P3','Mercury',185600)
GO

INSERT INTO Empregados VALUES(25348,'Matthew','Smith','D3')
INSERT INTO Empregados VALUES(10102,'Ann','Jones','D3')
INSERT INTO Empregados VALUES(18316,'John','Barrimore','D1')
INSERT INTO Empregados VALUES(29346,'James','James','D2')
INSERT INTO Empregados VALUES(9031,'Elke','Dertoni','D2')
INSERT INTO Empregados VALUES(2581,'Elsa','Hansel','D2')
